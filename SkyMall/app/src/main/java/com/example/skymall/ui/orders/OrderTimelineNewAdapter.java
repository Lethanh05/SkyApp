...
public class OrderTimelineNewAdapter extends RecyclerView.Adapter<OrderTimelineNewAdapter.ViewHolder> {
    private List<OrderDetailResp.OrderHistory> historyList;

    public OrderTimelineNewAdapter(List<OrderDetailResp.OrderHistory> historyList) {
