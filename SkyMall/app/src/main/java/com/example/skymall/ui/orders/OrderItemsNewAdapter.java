...
public class OrderItemsNewAdapter extends RecyclerView.Adapter<OrderItemsNewAdapter.ViewHolder> {
    private List<OrderDetailResp.OrderItem> items;

    public OrderItemsNewAdapter(List<OrderDetailResp.OrderItem> items) {
        this.items = items;
    }
